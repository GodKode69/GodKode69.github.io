...
export const skills: Skill[] = [
  ...
  {
    name: "Automation",
    icon: "/assets/icons/automation.webp",
  ...
  },
  {
    ...
    icon: "/assets/icons/container.webp",
  ...
  {
    name: "Virtualization",
    icon: "/assets/icons/amazon-s3.webp",
